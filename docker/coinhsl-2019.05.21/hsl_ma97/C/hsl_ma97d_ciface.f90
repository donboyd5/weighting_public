...
!DEC$ ATTRIBUTES DLLEXPORT :: ma97_default_control_d
...
subroutine ma97_analyse_d(ccheck, n, cptr, crow, cval, cakeep, ccontrol, &
      cinfo, corder) bind(C)
!DEC$ ATTRIBUTES DLLEXPORT :: ma97_analyse_d
   use hsl_ma97_double_ciface
   implicit none
...
subroutine ma97_analyse_coord_d(n, ne, crow, ccol, cval, cakeep, ccontrol, &
      cinfo, corder) bind(C)
!DEC$ ATTRIBUTES DLLEXPORT :: ma97_analyse_coord_d
   use hsl_ma97_double_ciface
   implicit none
...
!DEC$ ATTRIBUTES DLLEXPORT :: ma97_factor_d
   use hsl_ma97_double_ciface
   implicit none
...
!DEC$ ATTRIBUTES DLLEXPORT :: ma97_factor_solve_d
   use hsl_ma97_double_ciface
   implicit none
...
subroutine ma97_solve_d(job, nrhs, cx, ldx, cakeep, cfkeep, ccontrol, cinfo) &
      bind(C)
!DEC$ ATTRIBUTES DLLEXPORT :: ma97_solve_d
   use hsl_ma97_double_ciface
   implicit none
...
!DEC$ ATTRIBUTES DLLEXPORT :: ma97_free_akeep_d
   use hsl_ma97_double_ciface
   implicit none
...
!DEC$ ATTRIBUTES DLLEXPORT :: ma97_free_fkeep_d
   use hsl_ma97_double_ciface
   implicit none
...
!DEC$ ATTRIBUTES DLLEXPORT :: ma97_finalise_d
   use hsl_ma97_double_ciface
   implicit none
...
!DEC$ ATTRIBUTES DLLEXPORT :: ma97_enquire_posdef_d
   use hsl_ma97_double_ciface
   implicit none
...
subroutine ma97_enquire_indef_d(cakeep, cfkeep, ccontrol, cinfo, cpiv_order, &
      cd) bind(C)
!DEC$ ATTRIBUTES DLLEXPORT :: ma97_enquire_indef_d
   use hsl_ma97_double_ciface
   implicit none
...
!DEC$ ATTRIBUTES DLLEXPORT :: ma97_alter_d
   use hsl_ma97_double_ciface
   implicit none
...
!DEC$ ATTRIBUTES DLLEXPORT :: ma97_solve_fredholm_d
   use hsl_ma97_double_ciface
   implicit none
...
subroutine ma97_lmultiply_d(ctrans, k, cx, ldx, cy, ldy, cakeep, cfkeep, &
      ccontrol, cinfo) bind(C)
!DEC$ ATTRIBUTES DLLEXPORT :: ma97_lmultiply_d
   use hsl_ma97_double_ciface
   implicit none
...
!DEC$ ATTRIBUTES DLLEXPORT :: ma97_sparse_fwd_solve_d
   use hsl_ma97_double_ciface
   implicit none
