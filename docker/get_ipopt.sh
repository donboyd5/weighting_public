...
# use only one mv line, or comment both out, depending on hsl
# mv ../../coinhsl-2015.06.23 ThirdParty/coinhsl
mv ../../coinhsl-2019.05.21 ThirdParty/coinhsl
export IPOPTDIR=/tmp/ipopt/Ipopt-3.12.4/
cd $IPOPTDIR/ThirdParty/Blas && ./get.Blas
cd ../Lapack && ./get.Lapack
cd ../ASL && ./get.ASL
cd ../Mumps && ./get.Mumps
# comment out next line if not using HSL
